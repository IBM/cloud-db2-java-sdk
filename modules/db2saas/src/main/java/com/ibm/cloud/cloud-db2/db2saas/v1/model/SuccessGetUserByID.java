 ...
 */
public class SuccessGetUserByID extends GenericModel {
  ...
  protected SuccessGetUserByIDAuthentication authentication;

  protected SuccessGetUserByID() { }
   ...
   */
  public SuccessGetUserByIDAuthentication getAuthentication() {
