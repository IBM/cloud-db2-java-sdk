...
public class Db2saas extends BaseService {
 ...
 /**
  ...
  public ServiceCall<SuccessUserResponse> putDb2SaasUser(PutDb2SaasUserOptions putDb2SaasUserOptions) {
    ...
    contentJson.addProperty("iam", putDb2SaasUserOptions.newIam());
    contentJson.addProperty("ibmid", putDb2SaasUserOptions.newIbmid());
    contentJson.addProperty("name", putDb2SaasUserOptions.newName());
    contentJson.addProperty("password", putDb2SaasUserOptions.newPassword());
   ...
   */
  public ServiceCall<Void> deleteDb2SaasUser(DeleteDb2SaasUserOptions deleteDb2SaasUserOptions) {
  ...
  public ServiceCall<SuccessGetUserByID> getbyidDb2SaasUser(GetbyidDb2SaasUserOptions getbyidDb2SaasUserOptions) {
    ...
    Map<String, String> pathParamsMap = new HashMap<String, String>();
    pathParamsMap.put("id", getbyidDb2SaasUserOptions.id());
    RequestBuilder builder = RequestBuilder.get(RequestBuilder.resolveRequestUrl(getServiceUrl(), "/users/{id}", pathParamsMap));
