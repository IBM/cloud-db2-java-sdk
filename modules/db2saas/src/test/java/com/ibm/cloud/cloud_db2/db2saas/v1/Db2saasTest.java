...
import com.ibm.cloud.cloud_db2.db2saas.v1.model.SuccessCreateBackupTask;
...
import com.ibm.cloud.cloud_db2.db2saas.v1.model.SuccessGetUserByIDAuthentication;
import com.ibm.cloud.cloud_db2.db2saas.v1.model.SuccessGetUserInfo;
import com.ibm.cloud.cloud_db2.db2saas.v1.model.SuccessGetUserInfoResourcesItem;
import com.ibm.cloud.cloud_db2.db2saas.v1.model.SuccessGetUserInfoResourcesItemAuthentication;
...
import com.ibm.cloud.cloud_db2.db2saas.v1.model.SuccessTuneableParamsTuneableParam;
import com.ibm.cloud.cloud_db2.db2saas.v1.model.SuccessTuneableParamsTuneableParamDb;
import com.ibm.cloud.cloud_db2.db2saas.v1.model.SuccessTuneableParamsTuneableParamDbm;
...
import com.ibm.cloud.cloud_db2.db2saas.v1.model.SuccessUserResponseAuthentication;
...
import com.ibm.cloud.cloud_db2.db2saas.v1.Db2saas;
import com.ibm.cloud.cloud_db2.db2saas.v1.model.Backup;
...
public class Db2saasTest {
  ...
  public void testDeleteDb2SaasUserWOptions() throws Throwable {
    ...
    Response<Void> response = db2saasService.deleteDb2SaasUser(deleteDb2SaasUserOptionsModel).execute();
    assertNotNull(response);
  ...
  public void testGetbyidDb2SaasUserWOptions() throws Throwable {
    // Register a mock response
    String mockResponseBody = "{\"dvRole\": \"dvRole\", \"metadata\": {\"anyKey\": \"anyValue\"}, \"formatedIbmid\": \"formatedIbmid\", \"role\": \"bluadmin\", \"iamid\": \"iamid\", \"permittedActions\": [\"permittedActions\"], \"allClean\": true, \"password\": \"password\", \"iam\": false, \"name\": \"name\", \"ibmid\": \"ibmid\", \"id\": \"id\", \"locked\": \"no\", \"initErrorMsg\": \"initErrorMsg\", \"email\": \"user@host.org\", \"authentication\": {\"method\": \"method\", \"policy_id\": \"policyId\"}}";
    String getbyidDb2SaasUserPath = "/users/test-user";
    server.enqueue(new MockResponse()
      .setHeader("Content-type", "application/json")
      .setResponseCode(200)
      .setBody(mockResponseBody));
