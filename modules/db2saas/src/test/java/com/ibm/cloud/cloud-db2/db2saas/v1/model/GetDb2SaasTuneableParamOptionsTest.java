...
/**
 * Unit test class for the GetDb2SaasTuneableParamOptions model.
 */
public class GetDb2SaasTuneableParamOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetDb2SaasTuneableParamOptions() throws Throwable {
    GetDb2SaasTuneableParamOptions getDb2SaasTuneableParamOptionsModel = new GetDb2SaasTuneableParamOptions();
    assertNotNull(getDb2SaasTuneableParamOptionsModel);
  }
}