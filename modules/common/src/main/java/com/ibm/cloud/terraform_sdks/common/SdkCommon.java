...
// >>> Replace "terraform_sdks" with the correct value for your project
package com.ibm.cloud.terraform_sdks.common;
...
public class SdkCommon {
    ...
    // >>> Replace "terraform-sdks" with the parent project's artifactId (e.g. platform-services)
    private static String parentArtifactId = "terraform-sdks";
