...
/**
 * Unit test class for the SuccessGetWhitelistIPs model.
 */
public class SuccessGetWhitelistIPsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testSuccessGetWhitelistIPs() throws Throwable {
    SuccessGetWhitelistIPs successGetWhitelistIPsModel = new SuccessGetWhitelistIPs();
    assertNull(successGetWhitelistIPsModel.getIpAddresses());
  }
}