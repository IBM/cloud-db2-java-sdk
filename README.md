...
The IBM Cloud Db2 SaaS Java SDK allows developers to programmatically interact with the following IBM Cloud services:

Service Name | Artifact Coordinates
--- | ---
[Db2 SaaS](https://cloud.ibm.com/apidocs/db2SaaS) | com.ibm.cloud:example-service:0.0.1
...
### Gradle
```gradle
compile 'com.ibm.cloud:db2saas:0.0.1'
```
